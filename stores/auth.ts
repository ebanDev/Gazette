export const useAuthStore = defineStore('auth', () => {
        ...
        function logout() {
            ...
            // Optional: Reset API URL to default
            apiUrl.value = 'https://europresse-api.eban.eu.org';
        }
        ...
        return {username, password, provider, ent, cookies, cookiesDate, apiUrl, setAuthDetails, validateCookies, loggedIn, setApiUrl, logout}
    }, {
        persist: true,
    },
);
